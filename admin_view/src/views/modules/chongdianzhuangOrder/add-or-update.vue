    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="充电小时" prop="buyNumber">
                       <el-input v-model="ruleForm.buyNumber"
                                 placeholder="充电小时" clearable  :readonly="ro.buyNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="充电小时" prop="buyNumber">
                           <el-input v-model="ruleForm.buyNumber"
                                     placeholder="充电小时" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="chongdianzhuangOrderTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.chongdianzhuangOrderTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.chongdianzhuangOrderTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chongdianzhuangOrderTime" label="预约时间" prop="chongdianzhuangOrderTime">
                            <span v-html="ruleForm.chongdianzhuangOrderTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="chongdianzhuangOrderTruePrice">
                       <el-input v-model="ruleForm.chongdianzhuangOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.chongdianzhuangOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实付价格" prop="chongdianzhuangOrderTruePrice">
                           <el-input v-model="ruleForm.chongdianzhuangOrderTruePrice"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="chongdianzhuangOrderTypes">
                        <el-select v-model="ruleForm.chongdianzhuangOrderTypes" :disabled="ro.chongdianzhuangOrderTypes" placeholder="请选择订单类型">
                            <el-option
                                v-for="(item,index) in chongdianzhuangOrderTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="chongdianzhuangOrderValue">
                        <el-input v-model="ruleForm.chongdianzhuangOrderValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    chongdianzhuangOrderTypes: '',
                    insertTime: '',
                },
                chongdianzhuangOrderTypesOptions : [],
                ...
                rules: {
                   ...
                   buyNumber: [
                              { required: true, message: '充电小时不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongdianzhuang_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chongdianzhuangOrderTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `chongdianzhuangOrder/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chongdianzhuangOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chongdianzhuangOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
